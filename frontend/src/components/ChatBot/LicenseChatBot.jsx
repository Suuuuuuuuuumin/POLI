...
import { sendMessageToOpenAI } from "../../api/openAI/LicenseChatBotApi";
    ...
    <div className="container">
      <div className="chatBox" ref={chatBoxRef}>
        {messages.length === 0 ? (
          ...
          - AWS Certified Solutions Architect – Associate (2021)<br/>
          - Google Cloud Professional Machine Learning Engineer (2022)<br/>
          - 정보처리기사 (2020)
          </div>
        ) : (
          messages
