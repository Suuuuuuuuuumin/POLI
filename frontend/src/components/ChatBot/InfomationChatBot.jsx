...
import { sendMessageToOpenAI } from "../../api/openAI/InfomationChatBotApi";
    ...
    <div className="container">
      <div className="chatBox" ref={chatBoxRef}>
        {messages.length === 0 ? (
          ...
          끊임없이 성장하고 혁신을 추구하는 개발자입니다. 사람과 기술을 연결하여 문제를 해결하는 데에 가치를 두고 있으며, AI 기술을 활용한 맞춤형 솔루션 개발을 통해 사용자에게 의미 있는 변화를 만들어내는 데에 열정을 가지고 있습니다. POLI의 기술 비전과 가치에 공감하며, 이를 실현하기 위한 창의적이고 효율적인 솔루션을 제안하는 데 기여하고 싶습니다.
          </div>
        ) : (
          messages
