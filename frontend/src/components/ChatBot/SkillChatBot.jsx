...
import { sendMessageToOpenAI } from "../../api/openAI/SkillChatBotApi";
    ...
    <div className="container">
      <div className="chatBox" ref={chatBoxRef}>
        {messages.length === 0 ? (
          ...
          - 프로그래밍 언어: Python, JavaScript, Java, Go<br/>
          - 웹 프레임워크: React, Node.js, Django<br/>
          - 클라우드 플랫폼: Google Cloud, AWS, Azure<br/>
          - 데이터 분석/AI: TensorFlow, PyTorch, Scikit-learn, Pandas<br/>
          - DevOps: Docker, Kubernetes, CI/CD (GitHub Actions, Jenkins)<br/>
          - 기타: Git, SQL, NoSQL (MongoDB), RESTful API 설계
          </div>
        ) : (
          messages
